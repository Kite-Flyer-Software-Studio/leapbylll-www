      ...
      <Container>
        ...
        <div className="my-10 grid grid-cols-1 gap-4 md:my-20 md:grid-cols-2 lg:grid-cols-4">
          <Card className="lg:rounded-tl-3xl lg:rounded-bl-3xl">
            ...
            <CardContent>
              <CardTitle className="pt-6">Understand your business</CardTitle>
              <CardDescription>
          ...
          <Card>
            ...
            <CardContent>
              <CardTitle className="pt-6">Set up your LEAP stack</CardTitle>
              <CardDescription>
          ...
          <Card>
            ...
            <CardContent>
              <CardTitle className="pt-6">Run your business, we handle the rest</CardTitle>
              <CardDescription>
          ...
          <Card className="lg:rounded-tr-3xl lg:rounded-br-3xl">
            ...
            <CardContent>
              <CardTitle className="pt-6">Review, refine, and grow</CardTitle>
              <CardDescription>
